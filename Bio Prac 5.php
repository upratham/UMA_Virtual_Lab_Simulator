        ...
        <section id="practical-content">
            <div class="content">
                ...
                <div class="image-container">
                    <img src="Prac 5\1.png" alt="Sunflower" style="float: left; margin-right: 15px; width: 300px; height: auto;">
                </div>
                ...
                <div class="image-container">
                    <img src="Prac 5\2.png" alt="Fowler position" class="center">
            </div>
            <div class="image-container">
                <img src="Prac 5\3.png" alt="Fowler position" class="center">
        </div>
        <div class="image-container">
            <img src="Prac 5\4.png" alt="Fowler position" class="center">
    </div>
    <div class="image-container">
        <img src="Prac 5\5.png" alt="Fowler position" class="center">
</div>
...
<div style="margin-bottom: 30px;">
    ...
    <div style="display: flex; justify-content: space-between; align-items: center;">
        <img src="Prac 5\6.jpg" alt="Epitelio Bucal" style="width: 150px; height: auto;">
...
<div>
    <ol>
        <li>¿Qué es la célula?</li>
        <li>¿Cuántos tipos de células hay?</li>
        <li>¿Cuál es la importancia de la célula?</li>
        <li>Dibuje las partes de la célula vegetal y animal</li>
        <li>Esquematice las semejanzas y diferencias de la célula animal y vegetal</li>
        <li>Investigue las organelas de una célula procariota mencionando su función</li>
        <li>Investigue las organelas de una célula eucariota mencionando su función</li>
    </ol>
</div>
