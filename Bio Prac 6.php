        ...
        <section id="practical-content">
            <div class="content">
                ...
                <div class="image-container">
                    <img src="Prac 6\1.jpg" alt="Fowler position" class="center">
                </div>

                <div class="image-container">
                    <img src="Prac 6\2.png" alt="Fowler position" class="center">
                </div>

                <div class="image-container">
                    <img src="Prac 6\3.png" alt="Fowler position" class="center">
                </div>
                ...
                <div class="image-container">
                    <img src="Prac 6\4.jpg" alt="Fowler position" class="center" style="width: 300px; height: auto;">
                </div>
                ...
                <div class="image-container">
                    <img src="Prac 6\5.png" alt="Fowler position" class="center" style="width: 300px; height: auto;">
                </div>
                ...
                <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 20px;">
                    ...
                    <div style="width: 45%; text-align: center;">
                        <img src="Prac 6\6.jpg" alt="Célula animal" style="width: 100%; border: 1px solid #ccc; box-shadow: 2px 2px 10px rgba(0,0,0,0.1);">
                ...
                <div style="display: flex; justify-content: center; align-items: center;">
                    <!-- Célula Vegetal -->
                    <div style="width: 45%; text-align: center;">
                        <img src="Prac 6\7.jpg" alt="Célula vegetal" style="width: 100%; border: 1px solid #ccc; box-shadow: 2px 2px 10px rgba(0,0,0,0.1);">
            ...
            <div class="image-container">
                <img src="Prac 6\8.png" alt="Fowler position" class="center">
            </div>
    ...
    <ul>
        ...
        <li>✓ Plumón marcador.</li>
                 ...
                 <h3 id="Procedimiento">3.3	Procedimiento</h3>
                    ...
                    <div class="image-container">
                        <img src="Prac 6\9.png" alt="Fowler position" class="center">
                    </div>
                    ...
                    <div class="image-container">
                        <img src="Prac 6\10.png" alt="Fowler position" class="center">
                    </div>
                    ...
                    <div class="image-container">
                        <img src="Prac 6\11.png" alt="Fowler position" class="center">
                    </div>
                    <br>
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <div style="width: 45%; text-align: center;">
                                <img src="Prac 6\12.png" alt="Célula del Epitelio Bucal" style="width: 100%; border: 1px solid #ccc; box-shadow: 2px 2px 10px rgba(0,0,0,0.1);">
                    ...
                    <div>
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            <div style="width: 45%; text-align: center;">
                                <img src="Prac 6\13.png" alt="Espermatozoide Humano" style="width: 100%; border: 1px solid #ccc; box-shadow: 2px 2px 10px rgba(0,0,0,0.1);" class="center">
