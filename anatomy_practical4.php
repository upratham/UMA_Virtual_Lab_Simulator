...
<body>
    ...
    <div class="sidebar">
        <h2>Contenido   </h2>
        <a href="#digestive-overview">Descripción general del sistema digestivo</a>
        <a href="#small-intestine">Intestino delgado</a>
        <a href="#large-intestine">Intestino grueso</a>
        <a href="#accessory-glands">Glándulas accesorias</a>
        <a href="#urinary-overview">Descripción general del sistema urinario</a>
        <a href="#questionnaire">Cuestionario</a>
    </div>
    ...
    <div class="content">
        ...
        <section id="digestive-overview">
            ...
            <h1>Tabla del Sistema Digestivo</h1>
            <table class="table-container">
                <thead>
                    <tr>
                        <th>&Oacute;rgano</th>
            ...
            <h2 id="objectives"><strong>Glándulas anexas</strong></h2>
            <ul>
