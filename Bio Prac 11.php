...
<body>
    ...
    <div class="image-container">
        <img src="Prac 11\1.png" alt="Fowler position" class="center">
    </div>
    <ol>
        <li>
    ...
    <div class="image-container">
        <img src="Prac 11\2.png" alt="Fowler position" class="center">
    </div>

    <br>
    <div class="image-container">
        <img src="Prac 11\3.png" alt="Fowler position" class="center">
    </div>
    <br>
    <div class="image-container">
        <img src="Prac 11\4.png" alt="Fowler position" class="center">
    </div>
    <br>
    ...
    <table border="1" cellspacing="0" cellpadding="5" style="width: 100%; border-collapse: collapse;">
        ...
        <tbody>
            <tr>
                ...
                <td style="text-align: center;"><img src="Prac 11\5.png" alt="Dibujo Observación #1"></td>
                <td style="text-align: center;"><img src="Prac 11\5.png" alt="Dibujo Observación #2"></td>
                <td style="text-align: center;"><img src="Prac 11\5.png" alt="Dibujo Observación #3"></td>
                <td style="text-align: center;"><img src="Prac 11\5.png" alt="Dibujo Observación #4"></td>
            </tr>
            <tr>
